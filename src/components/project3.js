        ...
        return (
            <div>
                <div className="proj1-container">
                    ...
                    <img className="wanderlust-photo" src={pic1lg} alt="staccato landing page"/>
                    <img className="wanderlust-photo-md" src={pic1md} alt="staccato landing page"/>
                    <img className="wanderlust-photo-sm" src={pic1sm} alt="staccato landing page"/>
                    ...
                    <img className="wanderlust-imp-photo" src={pic2lg} alt="staccato dashboard"/>
                    <img className="wanderlust-photo-md" src={pic2md} alt="staccato dashboard"/>
                    <img className="wanderlust-photo-sm" src={pic2sm} alt="staccato dashboard"/>
