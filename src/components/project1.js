        ...
        return (
            <div>
                <div className="proj1-container">
                    ...
                    <img className="wanderlust-photo" src={pic1lg} alt="wanderlust application"/>
                    <img className="wanderlust-photo-md" src={pic1md} alt="wanderlust application"/>
                    <img className="wanderlust-photo-sm" src={pic1sm} alt="wanderlust application"/>
                    ...
                    <img className="wanderlust-imp-photo" src={pic2lg} alt="wanderlust saving trips"/>
                    <img className="wanderlust-photo-md" src={pic2md} alt="wanderlust saving trips"/>
                    <img className="wanderlust-photo-sm" src={pic2sm} alt="wanderlust saving trips"/>
