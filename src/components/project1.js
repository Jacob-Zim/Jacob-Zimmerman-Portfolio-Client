...
import wanderlust from '../images/pic1.PNG';
import wanderlustImp from '../images/pic3.PNG';
        ...
        return (
            <div>
                <div className="proj1-container">
                    ...
                    <p className="conclusion">After all was said and done we had our fully functional app, but we would do things differently if we were to do it again. It would be easier to organize our store with one person solely working on actions rather than a few, as we got mixed up at times with naming and organization. <br/><br/>Another thing we would change is spending a little more time researching as we got started coding pretty quick without having a complete picture of the end goal. <br/><br/> Overall, I think we did a great job with the time we had and worked together effectively. We were able to joke around and have a good time while working diligently, I couldn't have asked for a better team!</p>
                </div>
